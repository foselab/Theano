...
# Requirements Table
s.add(ForAll([y1,y2,y3,y4,y5] , Or(Or(True),Or(Not(Implies(u2[0]<7,y2[0]==100)),Not(Implies(u5[0]>0,And(y5[0]>0,y2[0]==15))),Not(Implies(u2[1]<7,y2[1]==100)),Not(Implies(u5[1]>0,And(y5[1]>0,y2[1]==15)))),Or(Not(Implies(u1[0]<10,y3[0]<5)),Not(Implies(u3[0]==5,y3[0]<50)),Not(Implies(u1[1]<10,y3[1]<5)),Not(Implies(u3[1]==5,y3[1]<50))),Or(Not(Implies(u4[0]==3,y4[0]>u4[0]+2)),Not(Implies(u4[0]==3,y4[1]>u4[0]+2))),Or(Not(Implies(u5[0]>0,And(y5[0]>0,y2[0]==15))),Not(Implies(u5[1]>0,And(y5[1]>0,y2[1]==15)))))))

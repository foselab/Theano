...
# Requirements Table
s.add(Or(And(Not(u1[0]==2),Not(u1[0]==1),Not(u1[0]>=1),Not(u1[0]!=2)),And(Not(u1[1]==2),Not(u1[1]==1),Not(u1[1]>=1),Not(u1[1]!=2)),And(Not(u1[2]==2),Not(u1[2]==1),Not(u1[2]>=1),Not(u1[2]!=2))))

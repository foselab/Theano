...
# Requirements Table
s.add(ForAll([y1,y2,y3,y4,y5] , Exists(i,Not(And(Implies(u1[i]<10,y1[i]==20),Implies(u2[i]==5,y2[i]<100),Implies(u3[i]>0,y3[i]>10),Implies(((i==0)*(y3[i])+(i>0)*(y3[i-1]))<15,y4[i]>10),Implies(u5[i]>0,y5[i]>0))))))

...
s.add(And(tau(1)-tau(0)==2.0,tau(2)-tau(1)==2.0,tau(3)-tau(2)==2.0,tau(4)-tau(3)==2.0,tau(5)-tau(4)==2.0,tau(6)-tau(5)==2.0,tau(7)-tau(6)==2.0,tau(8)-tau(7)==2.0,tau(9)-tau(8)==2.0))
# Requirements Table

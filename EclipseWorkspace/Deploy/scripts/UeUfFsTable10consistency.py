...
# Requirements Table
s.add(ForAll([y1,y2,y3,y4,y5] , Exists(i,Not(And(Implies(u1[i]>5,y5[i]==5),Implies(u2[i]==10,y2[i]==20),Implies(u3[i]<100,y3[i]<150),Implies(((i==0)*(u4[i])+(i>0)*(u4[i-1]))<10,y4[i]<20),Implies(u5[i]<50,y5[i]==30))))))

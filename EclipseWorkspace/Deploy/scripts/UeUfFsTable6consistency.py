...
# Requirements Table
s.add(ForAll([y1,y2,y3,y4] , Exists(i,Not(And(Implies(u1[i]<1,y1[i]<0),Implies(u2[i]>5,y2[i]>5),Implies(u3[i]<100,y3[i]==100),Implies(u4[i]>0,And(y4[i]>0,y2[i]>10)),Implies(((i==0)*(u4[i])+(i>0)*(u4[i-1]))>2,((i==0)*(y4[i])+(i>0)*(y4[i-1]))>20))))))

...
# Requirements Table
s.add(ForAll([y] , Exists(i,Not(And(Implies(tau(i)==0,y[i]==0),Implies(And(Not(tau(i)==0),u[i]>0),y[i]==((i==0)*(y[i])+(i>0)*(y[i-1]))+1),Implies(And(Not(tau(i)==0),((i==0)*(y[i])+(i>0)*(y[i-1]))==1023),y[i]==23))))))

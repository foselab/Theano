...
# Requirements Table
s.add(ForAll([y1,y2,y3,y4] , Exists(i,Not(And(Implies(u1[i]>0,y1[i]<0),Implies(u2[i]<0,y2[i]>0),Implies(u3[i]>0,y3[i]>0),Implies(((i==0)*(y3[i])+(i>0)*(y3[i-1]))>0,((i==0)*(y4[i])+(i>0)*(y4[i-1]))>0))))))
